...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H</a>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
     <?php  foreach($modules as $v){  ?>
         ...
         <dl id="menu-article">
             <dt><i class="Hui-iconfont">&#xe620;</i> <?php echo $v['module_name']; ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
             <dd>
                 <ul>
                    <?php foreach($v['child'] as $childv){   ?>
                         <li><a data-href="<?php echo $childv['module_url']; ?>" data-title="<?php echo $childv['module_name']?>" href="javascript:void(0)"><?php echo $childv['module_name'] ?></a></li>
                    <?php }?>
                 </ul>
             </dd>
         </dl>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/statics/admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
